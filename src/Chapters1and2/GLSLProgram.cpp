...
namespace GLSLShaderInfo {
    std::map < std::string, GLSLShader::GLSLShaderType> extensions = {
        ...
        { "_geom.glsl", GLSLShader::GEOMETRY },
...
void GLSLProgram::compileShader(const char * fileName) {
    ...
    // Check the file names extension to determine the shader type
...
void GLSLProgram::link() {
    ...
    if (status == GL_FALSE) throw GLSLProgramException(errString);
}
...
void GLSLProgram::printActiveUniformBlock() {
#ifdef __APPLE__
